...
%However, we can not identify the magnetic properties of the phase containing the AFM Kitaev point ($J=\Gamma=0$, $K=1$), since the points in this phase are still mapped to the points in the same phase under the FST.
