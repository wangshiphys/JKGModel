...
In Fig. \ref{fig:StructureFactors}(c)-(e), the SMSF peaked at the M-points indicating that the GS of the $J-K-\Gamma$ model around these model parameters could be stripe ordered. For the model parameters shown in Fig. \ref{fig:StructureFactors}(d) and (e), the GS of the classical model is stripe ordered, and our ED results suggest the stripe state persist in the quantum limit.
