...
The main effect of $\Gamma$ term on \emph{Stripe-A} and \emph{Stripe-D} is tilting the moment orientation away from the cubic axes directions, yielding \emph{Stripe-B} and \emph{Stripe-C}. Fig. \ref{fig:Proabilities}(e) is a representative probability map for \emph{Stripe-B}. The probability takes maximum value at the directions determined by Eq.\eqref{eq:S1}.
